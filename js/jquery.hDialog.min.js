...
function(b){g.op=d;g.open(a)});d.autoHide&&g.close()})},open:function(b){var a=this.op,d,e,f,h,k,m=overlayTpl=iframeTpl="",q=a.autoShow?b:c(a.box);d=parseInt(a.width);e=parseInt(a.height);k=""+parseInt(-(e/2))+"px 0 0 "+parseInt(-(d/2))+"px";a.beforeShow&&this.fire.call(this,a.beforeShow);switch(a.positions){case "top":f=0;h="50%";k="0 0 0 "+parseInt(-(d/2))+"px";break;case "left":f=h=k=0;break;case "bottom":f=parseInt(n.height()-e)+"px";h=parseInt(n.width()-d)+"px";k=0;break;default:f=h="50%"}a.isOverlay&&
